...
## Project Structure
    ...
    ├── food_groceries_deli_38029  # Django project configurations
...
1. Clone this repo and `cd food_groceries_deli_38029`
...
2. Clone this repo and `cd food_groceries_deli_38029`
